...
-   Author email
-   Project name
-   [Pug](https://pugjs.org/api/reference.html) for templating
-   [Sass](http://sass-lang.com/) (via [node-sass](https://github.com/andrew/node-sass))
-   [Browsersync](http://www.browsersync.io/) or [Webpack](https://webpack.js.org/) for bundle
