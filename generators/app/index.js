...
module.exports = class extends Generator {
	...
	writing() {
		...
		this.copy("src/app/shared/helpers/_add-class.js", "src/app/shared/helpers/_add-class.js");
		this.copy("src/app/shared/helpers/_css-supports.js", "src/app/shared/helpers/_css-supports.js");
		this.copy("src/app/shared/helpers/_get-children-by-class-name.js", "src/app/shared/helpers/_get-children-by-class-name.js");
		this.copy("src/app/shared/helpers/_has-class.js", "src/app/shared/helpers/_has-class.js");
		this.copy("src/app/shared/helpers/_is.js", "src/app/shared/helpers/_is.js");
		this.copy("src/app/shared/helpers/_move-focus.js", "src/app/shared/helpers/_move-focus.js");
		this.copy("src/app/shared/helpers/_remove-class.js", "src/app/shared/helpers/_remove-class.js");
		this.copy("src/app/shared/helpers/_scroll-to.js", "src/app/shared/helpers/_scroll-to.js");
		this.copy("src/app/shared/helpers/_set-attribute.js", "src/app/shared/helpers/_set-attribute.js");
		this.copy("src/app/shared/helpers/_set-height.js", "src/app/shared/helpers/_set-height.js");
		this.copy("src/app/shared/helpers/_toggle-class.js", "src/app/shared/helpers/_toggle-class.js");
		...
		if (this.jsOption === "browserify") {
			...
			this.copy("gulp/webpack.config.js", "gulp/webpack.config.js");
		}
		...
		if (this.cssOption === "sass") {
			if (this.sassSyntax === "sass") {
				...
				this.copyTpl(
					"src/app/styles/sass/base/variables.sass",
					"src/app/styles/base/variables.sass",
					templateData
				);
				this.copyTpl(
				...
				this.copyTpl(
					"src/app/styles/sass/base/index.sass",
					"src/app/styles/base/index.sass",
					templateData
				);
				this.copyTpl(
				...
				this.copyTpl(
					"src/app/styles/scss/base/variables.scss",
					"src/app/styles/base/variables.scss",
					templateData
				);
				this.copyTpl(
				...
				this.copyTpl(
					"src/app/styles/scss/base/index.scss",
					"src/app/styles/base/index.scss",
					templateData
				);
				this.copyTpl(
